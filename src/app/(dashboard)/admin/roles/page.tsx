...
const roles = [
  {
    ...
    description: "Akses penuh ke seluruh sistem termasuk pengelolaan user dan konfigurasi",
    permissions: {
  ...
  },
  {
    ...
    description: "Dapat mengelola arsip semua divisi dan mengakses konfigurasi storage",
    permissions: {
      "Lihat Semua Arsip": true,
      "Tambah Arsip": true,
      "Edit Arsip": true,
